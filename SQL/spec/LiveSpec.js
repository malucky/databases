  ...
  xit("Should insert posted messages to the DB", function(done) {
    ...
    request({method: "POST",
            ...
            function(error, response, body) {
              ...
              var queryString = 'SELECT messages.createdAt, messages.text, users.username, rooms.roomname FROM messages INNER JOIN users ON messages.id_users=users.id INNER JOIN rooms ON messages.id_rooms=rooms.id';
              var queryArgs = [];
